...
export default function ProfileSetting({ data }: ProfileSettingProps) {
  ...
  return (
    <ModalWrapper title="我的個人資料" layout="primary">
      <section className="p-8 md:px-4">
        <form className="flex flex-col gap-10">
            ...
            <div className="w-full flex flex-col gap-10 mdg:gap-6 mdg:order-2">
              ...
              <div>
                ...
                <Link href="/" className="no-underline">
                  <span className="text-blue-dark md:text-sm">
                    重設新的密碼
                  </span>
                </Link>
              </div>
          ...
          <div className="flex flex-col gap-10 md:gap-6">
            <div>
              <h3 className={`${inputTitleStyle} mb-2 md:mb-1`}>
                喜好遊戲種類
              </h3>
